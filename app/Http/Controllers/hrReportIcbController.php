...
class hrReportIcbController extends Controller
{
    public function index()
    {
        ...
        return view('../hr/dashboard/reporticb/index', compact('tahun'));
    }
    ...
    public function list(Request $request)
    {
        ...
        return view('../hr/dashboard/reporticb/list', compact('gabungData', 'tahun','peg'));
    }
    public function print(Request $request)
    {
        ...
        $pdf = Pdf::loadview('../hr/dashboard/reporticb/print', compact('gabungData', 'tahun','peg'));
