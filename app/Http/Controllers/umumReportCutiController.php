...
class umumReportCutiController extends Controller
{
    public function index()
    {
        ...
        return view('../umum/dashboard/report/reportcuti/index', compact('peg', 'bulan', 'tahun', 'tahunAwal', 'tahunAkhir', 'tahunSekarang'));
    }
 ...
 // SCB BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB
                ...
                // dd($SCB);
                return view('../umum/dashboard/report/reportcuti/list', compact('bulanAwal', 'bulanAkhir', 'tahun', 'peg', 'H', 'SK', 'SD', 'I', 'IPC', 'IC', 'M', 'lmbtx', 'lmbtjm', 'ipax', 'ipajam', 'dl', 'icb', 'SCTB', 'SCB'));
             ...
             $SCB = $SCB - $icbthini;
                ...
                return View('../umum/dashboard/report/reportcuti/listsemua', [
 ...
 // SCB BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB
                ...
                // dd($SCB);
                $pdf = Pdf::loadview('../umum/dashboard/report/reportcuti/print', compact('bulanAwal', 'bulanAkhir', 'tahun', 'peg', 'H', 'SK', 'SD', 'I', 'IPC', 'IC', 'M', 'lmbtx', 'lmbtjm', 'ipax', 'ipajam', 'dl', 'icb', 'SCTB', 'SCB'));

                return $pdf->setPaper('a4', 'potrait')->stream('Cuti Report.pdf');
                //  batassssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss----------------------------------------------------------------------------------------------------------------------------------------------------------
            } 
