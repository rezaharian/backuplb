...
class umumReportTlAkController extends Controller
{
    public function index()
    {
        return view('../umum/dashboard/report/reporttlak/index');
    }
    ...
    public function list(Request $request)
    {
        ...
        return view('../umum/dashboard/report/reporttlak/list', compact('tgl_awal', 'tgl_akhir', 'absentlak', 'jns', 'jenis'));
    }
    public function print(Request $request)
    {
        ...
        $pdf = Pdf::loadview('../umum/dashboard/report/reporttlak/print', compact('tgl_awal', 'tgl_akhir', 'absentlak', 'jns', 'jenis'));
