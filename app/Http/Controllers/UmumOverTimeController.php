...
class UmumOverTimeController extends Controller
{
    public function list()
    {
        $data = overt_h::limit(100)
            ->orderBy('ot_cod', 'desc')
            ->get();
        return view('umum.dashboard.overt.list', compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('umum.dashboard.overt.create', compact('hari', 'bag', 'ot_cod_d', 'kar'));
    }
    ...
    public function detail($id)
    {
        ...
        return view('umum.dashboard.overt.detail', compact('data', 'data_d'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('umum.dashboard.overt.edit', compact('data', 'data_d', 'ot_cod_d', 'jmlh_data_d', 'kar','hari','bag'));
    }
    ...
    public function print($id)
{
  ...
  $data_d = overtime::where('ot_cod', $data->ot_cod)
    ...
    $pdf = Pdf::loadview('umum.dashboard.overt.print', compact('data','data_d','tgl'));
