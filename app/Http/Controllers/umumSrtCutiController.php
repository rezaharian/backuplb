...
class umumSrtCutiController extends Controller
{
    public function list()
    {
        $sc = srtcuti::orderBy('ct_tgl', 'desc')
            ->limit(200)
            ->get();
        return view('../umum/dashboard/srtcuti/index', compact('sc'));
    }
    ...
    public function create()
    {
        ...
        return view('../umum/dashboard/srtcuti/create', compact('kode_unik'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('../umum/dashboard/srtcuti/edit', compact('cuti'));
    }
    ...
    public function print($id)
    {
        ...
        $pdf = Pdf::loadview('../umum/dashboard/srtcuti/print', compact('cuti'));
