...
use PhpOffice\PhpSpreadsheet\Style\Alignment;use Carbon\Carbon;


class umumReportPresensiController extends Controller
{
 
    public function index()
    {
        return view('../umum/dashboard/report/reportabsen/index');
    }
    public function list(Request $request)
    {
        if ($request->report_type == 'gaji_excel') {
            ...
            $url = '/umum/dashboard/report/reportabsen/rekapgaji_excel';
            ...
            foreach ($pegawai as $peg) {
                ...
                foreach ($pegawaiAbsen as &$item) {
                    ...
                    $pgw = pegawai::where('bagian', ['PROD. LANGSUNG', 'Q C                ', 'Q C', 'TEKNIK', 'PROD. TAK LANGS'])
                    ->pluck('no_payroll')
                    ->toArray(); // Mengubah hasil pluck menjadi array

                if (!empty($item['masuk']) && !empty($item['keluar']) && in_array($item->no_reg, $pgw)) {                        $masuk_time = Carbon::parse($item['masuk']);
                        $keluar_time = Carbon::parse($item['keluar']);
            ...
            return view('../umum/dashboard/report/reportabsen/list', [
    ...
    public function list_print(Request $request)
    {
        ...
        $pdf = Pdf::loadview('/umum/dashboard/report/reportabsen/list_print', ['shift3' => $shift3, 'shift2' => $shift2, 'uml2' => $uml2, 'uml1' => $uml1, 'pegawaiData' => $pegawaiData, 'tgl_awal' => $taw, 'tgl_akhir' => $tak, 'total_lembur' => $total_lembur]);
    ...
    public function uraianlembur(Request $request)
    {
        ...
        return view('../umum/dashboard/report/reportabsen/uraianlembur', ['pegawaiData' => $pegawaiData, 'tgl_awal' => $taw, 'tgl_akhir' => $tak, 'total_lembur' => $total_lembur]);
    }
    ...
    public function rekapgaji(Request $request)
    {
        ...
        return view('../umum/dashboard/report/reportabsen/rekapgaji', [
            'shift3' => $shift3,
            'shift2' => $shift2,
            'uml2' => $uml2,
            'uml1' => $uml1,
    ...
    public function uraianlembur_print(Request $request)
    {
        ...
        $pdf = Pdf::loadview('/umum/dashboard/report/reportabsen/uraianlembur_print', [
            'shift3_total' => $shift3_total,
            'shift2_total' => $shift2_total,
            'uml2_total' => $uml2_total,
            'uml1_total' => $uml1_total,
    ...
    public function rekapgaji_print(Request $request)
    {
        ...
        $pdf = Pdf::loadview('/umum/dashboard/report/reportabsen/rekapgaji_print', [
            'shift3_total' => $shift3_total,
            'shift2_total' => $shift2_total,
            'uml2_total' => $uml2_total,
            'uml1_total' => $uml1_total,
