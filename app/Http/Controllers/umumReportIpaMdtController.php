...
class umumReportIpaMdtController extends Controller
{
    public function index()
    {
        return view('../umum/dashboard/report/reportipamdt/index');
    }
    ...
    public function list(Request $request)
    {
        ...
        return view('../umum/dashboard/report/reportipamdt/list', compact('tgl_awal', 'tgl_akhir', 'absenDataL', 'peg', 'jumlah_mnt_ipa', 'jumlah_mnt_dt', 'jumlah_hari_ipa', 'jumlah_hari_dt'));
    }
    public function print(Request $request)
    {
        ...
        $pdf = Pdf::loadview('../umum/dashboard/report/reportipamdt/print', compact('tgl_awal', 'tgl_akhir', 'absenDataL', 'peg', 'jumlah_mnt_ipa', 'jumlah_mnt_dt', 'jumlah_hari_ipa', 'jumlah_hari_dt'));
