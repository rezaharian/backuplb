    ...
    <div class="section text-xs">
        <div class="row ">
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-2 ">
                        <a href="/superadmin/dashboard/problemmsn/create" class="btn btn-sm btn-primary rounded-0 mb-0">Tambah</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr class="table-row" style="cursor: pointer;">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between">
                                                <a href="{{ route('adm.problemmsn.edit', $item->id) }}" class="link-icon">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="{{ route('adm.problemmsn.print_d', $item->id) }}" class="link-icon" target="_blank">
                                                    <i class="fas fa-print"></i>
                                                </a>
                                                <a href="{{ route('adm.problemmsn.delete', $item->id) }}" onclick="return confirm('Apakah Anda Yakin ?');" class="link-icon">
