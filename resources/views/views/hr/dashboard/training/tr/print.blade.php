...
<body>
    ...
    <img width="20%" src="https://hrrecruitment.extrupack.com/wp-content/uploads/2022/06/logo-extrupack-1-scaled.jpg"
        alt="https://hrrecruitment.extrupack.com/wp-content/uploads/2022/06/logo-extrupack-1-scaled.jpg">
    ...
    <div>
        <div>
            <table style="background: rgb(255, 255, 255); border:0;   font-family: Arial, Helvetica, sans-serif;">
                <tr>
                    <td style="width:30%; ">Nama Pelatihan </td>
                    <td> : <strong> {{ $view->pltran_nam }} </strong></td>
                </tr>
                <tr>
                    <td>Tanggal </td>
                    <td> : <strong> {{ $view->train_dat }} </strong></td>
                </tr>
                <tr>
                    <td>Waktu </td>
                    <td> : <strong> {{ $view->jam }} </strong> </td>
                </tr>
                <tr>
                    <td>Tempat </td>
                    <td> : <strong> {{ $view->tempat }} </strong></td>
                </tr>
                <tr>
                    <td>Instruktur </td>
                    <td> : <strong> {{ $view->pemateri }} </strong></td>
                </tr>
                <tr>
                    <td>Materi </td>
                    <td> : <strong> {{ $view->train_tema }} </strong></td>
                </tr>
            </table>
        </div>
