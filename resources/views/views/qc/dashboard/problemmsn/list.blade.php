                        ...
                        <tbody>
                            @forelse ($prob_h as $item)
                                <tr class="bg-gradient-light   ">
                                    ...
                                    <td>{{ $item->masalah }}</td>
                                    <td>
                                    <a href="{{ route('problemmsn.edit', $item->id) }}"
                                            class="btn btn-sm btn-primary ">Edit</a>
                                            <a href="{{ route('problemmsn.print_d', $item->id) }}"class="btn btn-sm btn-warning  " target="_blank">Print</a>
                                            <a href="{{ route('problemmsn.delete', $item->id) }}" onclick="return confirm('Apakah Anda Yakin ?');" class="btn btn-sm btn-danger">Hapus</a>
