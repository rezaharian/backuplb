...
@section('content')
            ...
            <div class="card ms-4 ">
                ...
                <div class=" sticky-top bg-gradient-info ">
                    ...
                    <div class="row  mx-1 ">
                        <div class="col-md-1 ">
                            <form class="mt-3 "
                                action="{{ route('superadmin.delete.datacap', ['jalur_id' => $arr['jalur_id']]) }}">
                                @csrf
                                @method('DELETE')
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="container-fluid py-4">
                                                        ...
                                                        <nav
                                                            ...
                                                            <div class="container">
                                                                <form
                                                                    action="{{ url('/superadmin/dashboard/loogbok/insertfielddatacap', ['jalur_id' => $arr['jalur_id']]) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @if ($errors->any())
                        ...
                        <div class="col-md-6 text-center">
                            ...
                            <div class="col-md-12   ">
                                <form class="form-group success "
                                    action="{{ url('/superadmin/dashboard/loogbokcap/insertfielddata', ['jalur_id' => $arr['jalur_id']]) }}"
                                    method="POST">
                                    @csrf
                            ...
                            <div class="row rounded border pt-1 ms-1 shadow  text-center ">
                                <div class="col-md-5 mt-2 ">
                                    <form class="form-group"
                                        action="{{ route('superadmin.index.cari.datacap', ['jalur_id' => $arr['jalur_id']]) }}"
                                        method="GET">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-xs font-weight-bold mb-0">
                                            <a class="btn bg-gradient-danger btn-sm"
                                                href="{{ route('superadmin.reset.datacap', ['jalur_id' => $data->jalur_id, 'data' => $data->id]) }}">R</a>
                                            <a
                                                class="btn bg-gradient-success btn-sm "href="{{ route('superadmin.batalresetpcs.datacap', ['jalur_id' => $data->jalur_id, 'data' => $data->id]) }}">B</a>
                                        ...
                                        <td class="text-xs font-weight-bold mb-0">
                                            <a
                                                class="btn bg-gradient-danger btn-sm "href="{{ route('superadmin.resetwaktu.datacap', ['jalur_id' => $data->jalur_id, 'data' => $data->id]) }}">R</a>
                                            <a
                                                class="btn bg-gradient-success btn-sm "href="{{ route('superadmin.batalresettime.datacap', ['jalur_id' => $data->jalur_id, 'data' => $data->id]) }}">B</a>
    ...
    @foreach ($prev as $item)
        ...
        <script type="text/javascript">
            ...
            $('.update').editable({
                url: "{{ route('superadmin.update.datacap', ['jalur_id' => $data->jalur_id, 'data' => $data->id]) }}",
                type: 'text',
                pk: 1,
                name: 'name',
                title: 'Enter name',
