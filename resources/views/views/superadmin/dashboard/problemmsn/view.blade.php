                ...
                <div class="col-md-5">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea disabled class="form-control" type="text" name="perbaikan" value="{{ $view_d->perbaikan }}" required>{{ $view_d->perbaikan }}</textarea>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea disabled class="form-control" type="text" name="pencegahan" value="{{ $view_d->pencegahan }}" required>{{ $view_d->pencegahan }}</textarea>
                            </td>
                        </tr>
                    </table>
                </div>
