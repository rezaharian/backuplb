    ...
    <div>
        @if (empty($no_payroll))
            <div style="display: flex; gap: 10px;" class="my-1">
                ...
                <a target="_blank" href="/umum/dashboard/report/reportabsen/list_print?tgl_awal={{ $tgl_awal }}&tgl_akhir={{ $tgl_akhir }}&no_payroll={{ $no_payroll }}">
                    <button class="btn btn-sm btn-warning m-0">Print</button>
                </a>
                <a target="_blank" href="/umum/dashboard/report/reportabsen/uraianlembur_print?tgl_awal={{ $tgl_awal }}&tgl_akhir={{ $tgl_akhir }}&no_payroll={{ $no_payroll }}">
                    <button class="btn btn-sm btn-warning m-0">Lembur</button>
                </a>
                {{-- <a target="_blank" href="/umum/dashboard/report/reportabsen/rekapgaji_print?tgl_awal={{ $tgl_awal }}&tgl_akhir={{ $tgl_akhir }}&no_payroll={{ $no_payroll }}">
                    ...
                    <div class="mt-2">
                        <div class="section text-light fw-bold">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <a target="_Blank"
                                        href="/umum/dashboard/report/reportabsen/list_print?tgl_awal={{ $tgl_awal }}&tgl_akhir={{ $tgl_akhir }}&no_payroll={{ $data['pegawai']->no_payroll }}">
                                        <button class="btn btn-sm btn-success">Print </button>
                                    </a>
                                    <a
                                        href="/umum/dashboard/report/reportabsen/uraianlembur?tgl_awal={{ $tgl_awal }}&tgl_akhir={{ $tgl_akhir }}&no_payroll={{ $data['pegawai']->no_payroll }}">
                                        <button class="btn btn-sm btn-success">Lembur</button>
                                    </a>
                                    {{-- <a
                                        href="/umum/dashboard/report/reportabsen/rekapgaji?tgl_awal={{ $tgl_awal }}&tgl_akhir={{ $tgl_akhir }}&no_payroll={{ $data['pegawai']->no_payroll }}">
