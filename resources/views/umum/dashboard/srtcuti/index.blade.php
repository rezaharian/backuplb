...
@section('content')
    ...
    <section>
        <div>
            <a href="../../../umum/dashboard/srtcuti/create" class="btn btn-primary btn-sm rounded-0">
                                ...
                                @foreach ($sc as $data)
                                    <tr style="font-size: 9pt;">
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('umum.srtcuti.edit', $data->id) }}">
                                                <i class="fas fa-pen"></i></a>
                                            <a class="mx-2" href="{{ route('umum.srtcuti.delete', $data->id) }}"
                                                onclick="return confirm('Apakah Anda Yakin ?');"><i
                                                    class="fas fa-trash"></i></a>
                                            <a href="{{ route('umum.srtcuti.print',  $data->id) }}"
