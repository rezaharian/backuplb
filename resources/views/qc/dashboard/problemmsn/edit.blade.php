                ...
                <tbody id="tbl-barang-body">
                    ...
                    @forelse ($data_d as $item)
                        <tr>
                            ...
                            <td>    <textarea cols="20" rows="1" class="form-control"    name="penyebab[]" value="{{ $item->penyebab }}">{{ $item->penyebab }} </textarea></td>
                            <td>    <textarea cols="20" rows="1" class="form-control"   type="text" name="perbaikan[]"
                                    value="{{ $item->perbaikan }}" >{{ $item->perbaikan }}</textarea></td>
                            <td><input class="form-control" type="date" name="tgl_rpr[]"
                                    value="{{ $item->tgl_rpr }}" ></td>
                            <td>    <textarea cols="20" rows="1" class="form-control"   type="text" name="pencegahan[]"
...
<script>
    $(function() {
        ...
        <tr>
            ...
            <td>
                  <textarea cols="20" rows="1"  type="text"   name="perbaikan[` + (count - 1) + `]" class="form-control" required> </textarea>
                </td>
            <td>
