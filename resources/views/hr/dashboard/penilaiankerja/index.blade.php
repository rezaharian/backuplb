...
@section('content')
    <style>
        ...
        .icon-link i {
            ...
            /* Warna ikon */
            border-radius: 50%;
            /* Untuk membuat ikon berbentuk lingkaran */
        }

        .icon-view i {
            background-color: #00ddff;
            /* Warna latar belakang ikon edit */
        }
        ...
        .icon-print i {
            ...
            /* Warna latar belakang ikon print */
        }

        .icon-delete i {
            background-color: #dc3545;
            /* Warna latar belakang ikon delete */
        }
    ...
    <div class="container">
        ...
        <div>
            <div class="row  m-0">
                <div class="col-md-2 m-0"> <a href="/hr/dashboard/penilaiankerja/create">
                        <button class="btn btn-sm btn-primary rounded-0 m-0">Tambah</button>
                    </a></div>
                <div class="col-md-10 m-0 bg-primary text-light fw-bold"> {{ $jumlahygsudah }} / {{ $jumlahsemua }}<small> Karyawan </small>
                </div>
            </div>
                                ...
                                @foreach ($pkinerja as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{-- <a href="{{ route('hr.penilaiankerja.view', $item->id) }}"
                                                class="icon-link icon-view">
                                                <i class="fas fa-eye"></i>
                                            </a> --}}
                                            <a href="{{ route('hr.penilaiankerja.edit', ['id' => $item->id]) }}"
                                                class="icon-link icon-edit">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="{{ route('hr.penilaiankerja.print', ['id' => $item->id]) }}"
                                                class="icon-link icon-print" target="_blank">
                                                <i class="fas fa-print"></i>
                                            </a>
                                            <a href="{{ route('hr.penilaiankerja.delete', ['id' => $item->id]) }}"
                                                class="icon-link icon-delete"
                                                onclick="return confirm('Apakah Anda yakin akan menghapus item ini?')">
