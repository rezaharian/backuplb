...
@section('content')
    ...
    {{-- <section>
        <div class="row m-0 text-center">
            <h4 class="">PERFORMANCE ATTENDANCE</h4>
        </div>
    </section> --}}
    <section class="text-muted">
        <div class="row">   
            <div class="col-md-5 card m-0 border-primary p-1">
                <form class="form-row" method="post" action="{{ route('hr.penilaiankerja.store') }}">
                    @csrf
            ...
            <div class="col card border-primary px-1 ms-1" style="height:510px;overflow:auto; width:auto;">
                <div class=" ">
                    ...
                    <div class="row" style="font-size: 10pt;">
                        ...
                        <div class="card m-1 p-1 bordered border-primary ">
                            ...
                            <hr class="p-0 text-center  mt-1" style="width: 96%; margin: 0 auto;">
                        </div>
                        @endforeach
                    </div>
                    <label for="" class="text-center mt-1">C. ASPEK PENILAIAN TEAM BY MANAGEMENT OBJECTIVE</label>
                    <hr>
                    <div class="row">
                        <div class="col-12 mt-1">
                    ...
                    <div class="row">
                        <div class="col">
                            <label for=".">Score </label>
                            <input type="number" class="form-control form-control-sm" max="100"  name="score_c">
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            select3.on('change', function() {
                ...
                if (selectBagian) {
                    $.ajax({
                        url: '/kelengkapandataperbagianhr/' + selectBagian,
                        type: 'GET',
                        success: function(data) {
