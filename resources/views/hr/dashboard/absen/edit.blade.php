...
@section('content')
    ...
    @endif
        <form class=" px-2  " action="{{ url('/hr/dashboard/absen/update', $data->id) }}" method="POST"
                            ...
                            @foreach ($data_d as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-danger btn-md m-0" onclick="return confirm('Apakah Anda Yakin  ?');"
                                            href="{{ route('hr.absen.delete_d', $item->id) }}"><i
    ...
    <div class=" btnSave  text-center item-center mt-2">
        <button type="submit" class="btn btn-primary btn-sm border-success card-plain">Simpan</button>
    </div>
    </form>
