...
@section('content')
    <div class="container">
        <form action="{{ url('/hr/dashboard/absen/store', ['bln' => $bln, 'thn' => $thn]) }}" method="POST"
            ...
            @endif
                <div class="card card-plain rounded-0 bordered border-primary  ">
                       <div class="row mt-2">
                    <div class="col-md-6">
                        <table class="table table-sm">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input hidden class="form-control form-control-sm" name="int_absen"
                                        value="{{ $int_absen }}">
                            ...
                            <tr>
                                ...
                                <td><input class="form-control form-control-sm" id="nama_asli" type="text"
                                        name="nama_asli" value="">
                                </td>
                            </tr>
                            <td hidden>
                                <input type="text" name="int_peg" value="{{ $int_peg }}" class="form-control form-control-sm" >
                            </td>
                        </table>
                    ...
                    <div class="col-md-6">
                        <table class="table table-sm">
                            <tr>
                                ...
                                <td><input class="form-control form-control-sm" id="tgl_masuk" type="text"
                                        name="tgl_masuk" value="">
                                </td>
                            </tr>
                            <tr>
    ...
    <div class=" btnSave card-plain  text-center item-center mt-2">
