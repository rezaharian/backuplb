        ...
        <div class="row">
            <div class="col-md-5 card m-0 border-primary p-1">
                <form class="form-row" method="post"
                    action="{{ route('tr.hr.penilaiankerja.update', ['id' => $pkinerja->id]) }}">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            name="awal" value="{{ $pkinerja->awal }}" required readonly >
                        </div>
                        <div class="col">
                            <input type="date" class="form-control form-control-sm text-muted" placeholder="akhir" id="akhir"
                            name="akhir" value="{{ $pkinerja->akhir }}" required readonly >
                        </div>
                    </div>
                    ...
                    <div class="row" style="font-size: 10pt;">
                        ...
                        <div class="card bordered border-primary p-1">
                            ...
                            <div class="col-md-12 m-0">
                                <textarea class="fw-bold m-1" name="penjelasan[]" style="text-align: justify;  border:hidden" cols="78" rows="4" readonly>{{ $item->penjelasan }}</textarea>
                            </div>
                            <div class="row">
                                <div class="col-md-4 m-0">
                                    <input type="number" id="nilai1" class="form-control form-control-sm" name="nilai1[]" min="0" max="5" value="{{ $item->nilai1 }}" @if ($namaprofile->name !== $item->un1 && $item->nilai1 != 0) readonly @endif>
                                </div>
                                <div class="col-md-4 m-0">
                                    <input type="number" id="nilai2" class="form-control form-control-sm" name="nilai2[]" min="0" max="5" value="{{ $item->nilai2 }}" @if ($namaprofile->name !== $item->un2 && $item->nilai2 != 0) readonly @endif>
                                </div>
                                <div class="col-md-4 m-0">
                                    <input type="number" id="nilai3" class="form-control form-control-sm" name="nilai3[]" min="0" max="5" value="{{ $item->nilai3 }}" @if ($namaprofile->name !== $item->un3 && $item->nilai3 != 0) readonly @endif>
                                </div>
                            </div>
