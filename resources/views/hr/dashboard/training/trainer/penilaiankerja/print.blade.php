...
<body>
    ...
    <div style="margin-top: 5%">
        ...
        <span class="column">Date Of Assignment <br> Hiring Date <br> Contract Period <br> Status</span>
        <span class="column"> : . . . . . . . . . . . . . . . . . . <br> :
            {{ \Carbon\Carbon::parse($peg->tgl_masuk)->translatedFormat('d F Y') }} <br> : {{ $kontrak_period }} <br> :
            {{ $peg->jns_peg }}</span>
    </div>
