        ...
        <section>
            ...
            <div class="row">
                ...
                <div class="text-end col-md-1  ">
                    <a href="{{ route('tr.hr.penilaiankerja.edit', ['id' => $pkinerja->id]) }}" target="" class="te">
                        <i class="fas   fa-pen" id="print-icon"></i>
                    </a>

                </div>
                <div class="text-end col-md-1  text-left">

                    <a href="{{ route('tr.hr.penilaiankerja.print', ['id' => $pkinerja->id]) }}" target="_blank"
                        class="text-primary">
