...
@section('content')
    ...
    <div class="container  px-2">
        ...
        <form action="{{ url('/trainer/store') }}" method="POST" enctype="multipart/form-data">
            ...
            <tr>
                <td><label for="example-text-input" class="form-control-label text-secondary">Materi Pelatihan </label></td>
                <td>
                    <textarea class="form-control form-control-sm" type="text" name="train_tema" value="" required></textarea>
                </td>
            </tr>
            </table>
