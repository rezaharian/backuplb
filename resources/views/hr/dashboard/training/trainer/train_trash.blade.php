...
<a href="/trainer/restore_all/{{ $item->train_cod }}" class="btn btn-success btn-sm">Restore All</a>
@endforeach
</div>
...
<table class="table">
    ...
    <tr>
        ...
        <td>{{ $item->approve }}</td>  
        <td>
            <a href="/trainer/restore_trash/{{ $item->id }}" class="btn btn-success btn-sm">Restore</a>
