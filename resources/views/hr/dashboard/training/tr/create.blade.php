...
@section('content')
    ...
    <div class="container  px-2">
        ...
        <form action="{{ url('/hr/dashboard/training/tr/store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
                ...
                <div class="row ">
                    ...
                    <div class="col-md-4">
                        ...
                        <table class="table table-sm ">
                            ...
                            <tr>
                                <td><label for="example-text-input" class="form-control-label  text-secondary">No Doc
                                    </label>
                                </td>
                            ...
                            <tr>
                                <td><label for="example-text-input" class="form-control-label text-secondary">Tempat
                                    </label>
                                </td>
                            ...
                            <tr>
                                <td><label for="example-text-input" class="form-control-label text-secondary">Pemateri
                                    </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td><label for="example-text-input" class="form-control-label text-secondary">Pelatihan
                                    </label>
                                </td>
                                <td>
                    ...
                    <div class="col-md-4">
                        <table class="table table-sm">
                            ...
                            <tr>
                                <td><label for="example-text-input" class="form-control-label text-secondary">Tipe </label>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td><label for="example-text-input" class="form-control-label text-secondary">Jam </label>
                                </td>
                                <td>
                                    <div class="row">
                                        <div class="col-md-5">
                    ...
                    <div class="col-md-4">
                        <table class="table table-sm">
                            ...
                            <tr>
                                ...
                                <td><label for="example-text-input" class="form-control-label text-secondary">Materi
                                        Pelatihan
                                    </label></td>
                                <td>
                                    <select class="form-control form-control-sm" type="text" id="state-dropdown"
                                        name="train_tema" value="" required>
                            ...
                            <tr>
                                ...
                                <td><label for="example-text-input" class="form-control-label text-secondary">File Daftar
                                        Kehadiran
                                    </label></td>
                        ...
                        {{-- 
                    <label class="form-control-label text-secondary ">File Materi Pelatihan:</label>
                    <div class="col-md-10">
                ...
                <div class="col-md-4 ">
                    <div class="row mt-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-select form-select-sm" name="approve_h"
                                aria-label="Default select example">
                                <option selected value="NO">NO</option>
                                <option value="YES">YES</option>
                            </select>
                        </div>
                        <div class="col-md-3 btnSave  text-center item-center">
        ...
        <script>
            ...
            <tr>
                ...
                <td class="text-center"><button class="btn removeItem m-0 btn-sm btn-danger "><i class="fas fa-trash"></i></button></td>
            </tr>
            `);
