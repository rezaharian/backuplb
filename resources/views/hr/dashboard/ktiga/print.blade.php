...
<body>
    ...
    <div>
        ...
        <table class="bordered-table">
            ...
            <tr>
                ...
                <td colspan="4" style="border: 1px solid black; border-left: none; ">
            ...
            <tr>
                <td colspan="3" style="border: 1px solid black; border-right: none;">
                    <label>Rencana verifikasi Pencegahan tanggalb</label>
                </td>
                <td colspan="3" style="border: 1px solid black; border-left: none; ">
    ...
    <div style="text-align: center;">
        <img src="{{ public_path('/uploads/ktiga/' . $data->file_foto) }}" alt="" style="width: 50%; height: auto;">
    </div>
    
    
    @else
        <small>*Tidak ada Lapiran Dokumen / Photo</small>
    @endif
