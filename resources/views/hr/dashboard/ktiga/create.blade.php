...
<div >
    <div class="card card-plain card1">
        ...
        <div class="">
            <form action="/hr/dashboard/ktiga/store" method="POST" enctype="multipart/form-data">
                @csrf
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid black;" colspan="5">
                                        <input type="radio" name="klas_temuan" value="Ketidaksesuaian Kritis" id="option1">
                                        <label for="option1" class="radio-label me-4">Ketidaksesuaian Kritis </label>

                                        <input type="radio" name="klas_temuan" value="Ketidaksesuaian Mayor" id="option2">
                                        <label for="option2" class="radio-label  me-4">Ketidaksesuaian Mayor</label>

                                        <input type="radio" name="klas_temuan" value="Ketidaksesuaian Minor" id="option3">
                                        <label for="option3" class="radio-label  me-4">Ketidaksesuaian Minor</label>

                                        <input type="radio" name="klas_temuan" value="Saran perbaikan / Observasi"
                                            id="option4">
                                ...
                                <tr>
                                    <td colspan="2" style="border: 1px solid black; border-right: none;"><label
                                        ...
                                        <input class="form-control form-control-sm" type="text" name="pemohon1"
                                            id="field1">
                                    </td>
                                    ...
                                    <td colspan="2" style="border: 1px solid black; border-right: none;"><label
                                        ...
                                        <input class="form-control form-control-sm" type="Text" name="penerima"
                                            id="field1">
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid black;" colspan="6">
                                        <textarea class="form-control form-control-sm mb-2" name="analisa_sebab" style="height: 150px;"></textarea>
                                        <div class="row">
                                            <div class="col-md-2">  <label style="text-align: right;" class="form-control-label text-secondary">Analis</label><input class="form-control form-control-sm" type="text" 
                                                name="analis"id="field1"></div>
                                            <div class="col-md-2">   <label style="text-align: right;" class="form-control-label text-secondary">Tgl Analis</label><input class="form-control form-control-sm" type="date" 
                                ...
                                <tr>
                                    <td colspan="4" style="border: 1px solid black; border-right: none;">
                                        <textarea class="form-control form-control-sm mb-2" name="perbaikan" style="height: 40px;"></textarea>
                                    </td>
                                    <td colspan="1" style="border: 1px solid black; border-right: none;">
                                        <input class="form-control form-control-sm" type="text" name="pj_perbaikan"
                                            id="field1">
                                    </td>
                                    <td colspan="1" style="border: 1px solid black;">
                                        <input class="form-control form-control-sm" type="date" name="batas_perbaikan"
                                            id="field1">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="border: 1px solid black; border-right: none;">
                                        ...
                                        <label for="option4"class="form-control-label text-secondary">Rencana veririfikasi Perbaikan
                                            tanggal:</label>
                                    </td>
                                    <td colspan="4" style="border: 1px solid black; ">
                                        </label>
                                        <input class="form-control form-control-sm" type="date" name="r_verifikasi_perbaikan"
                                            id="field1">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="border: 1px solid black; border-right: none;"><label
                                            for="example-text-input" class="form-control-label text-secondary">Tanggal
                                            :</label>
                                        <input class="form-control form-control-sm" type="date" name="tgl_atasan"
                                            id="field1">
                                    </td>
                                    <td colspan="2" style="border: 1px solid black; border-right: none;"><label
                                            for="example-text-input" class="form-control-label text-secondary">Paraf PIC
                                ...
                                <tr>
                                    <td colspan="4" style="border: 1px solid black; border-right: none;">
                                        <label for="example-text-input" class="form-control-label text-secondary">Catatan
                                            tindak lanjut:</label>
                                        <textarea class="form-control form-control-sm mb-2" name="pencegahan" style="height: 60px;"></textarea>
                                    </td>
                                    <td  colspan="4" style="border: 1px solid black;">
                                        ...
                                        <div id="catatanTidakEfektif" style="display: none;">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="catatan_te"
                                                id="catatan">
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="3" style="border: 1px solid black; ">
                                        ...
                                        <td colspan="3" style="border: 1px solid black; ">
                                            <input class="form-control form-control-sm" type="date" name="r_verifikasi_cegah"
                                                id="field1">
                                        </td>
                                </tr>
                                <tr>
