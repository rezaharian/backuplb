    ...
    <div class="section">
        <div class="row">
            <div class="row text-center mb-3">
                <h5 class="font-weight-bolder mb-0">Daftar Masalah Mesin</h5>
            </div>
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-1 ">
                    ...
                    <div class="col-md-2 ">
                        <form class="form-group"action="{{ route('op.problemmsn.index') }}" method="GET">
                        ...
                        <tbody>
                            @forelse ($list as $item)
                                <tr class=" text-xs  ">
                                    ...
                                    <td>{{ $item->prob_cod }}</td>
                                    <td style="text-align: center;"><a href="{{ route('op.problemmsn.view_d', $item->id) }}">
